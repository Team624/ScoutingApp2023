...
Future<List<Performance>> performance() async {
  ...
  return List.generate(maps.length, (i) {
    return Performance.complete(
        ...
        teleop_cone_L1: maps[i]["teleop_cone_L1"],
        teleop_hybrid_L2: maps[i]["teleop_hybrid_L2"],
        teleop_cone_L3: maps[i]["teleop_cone_L3"],
        teleop_cone_L4: maps[i]["teleop_cone_L4"],
        teleop_hybrid_L5: maps[i]["teleop_hybrid_L5"],
        teleop_cone_L6: maps[i]["teleop_cone_L6"],
        teleop_cone_L7: maps[i]["teleop_cone_L7"],
        teleop_hybrid_L8: maps[i]["teleop_hybrid_L8"],
        teleop_cone_L9: maps[i]["teleop_cone_L9"],
